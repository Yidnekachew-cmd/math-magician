...
const Home = () => (
  <div className="bg-home-bg h-screen bg-contain lg:bg-cover lg:bg-center w-full bg-no-repeat absolute top-0">
    ...
    <div className="hidden absolute  lg:top-[28%] px-10 lg:block">
      ...
      {/* eslint-disable-next-line max-len  */}
      <p className="w-[37%] text-xl text-justify tracking-wide leading-8">Welcome to my calculator app, your go-to tool for effortless math solutions. With a user-friendly interface, my app streamlines calculations for students, professionals, and anyone on the go. Plus, I&apos;ve integrated entertaining quotes to inspire and uplift you while you work. Say hello to simplified math and a dose of inspiration, all in one handy app.</p>
    </div>
  </div>
);
export default Home;
